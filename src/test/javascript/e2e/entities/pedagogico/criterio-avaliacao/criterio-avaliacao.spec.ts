...
describe('CriterioAvaliacao e2e test', () => {
  ...
  it('should load CriterioAvaliacaos', async () => {
    ...
    expect(await criterioAvaliacaoComponentsPage.getTitle()).to.eq('educacaoApp.pedagogicoCriterioAvaliacao.home.title');
  });
  ...
  it('should load create CriterioAvaliacao page', async () => {
    ...
    expect(await criterioAvaliacaoUpdatePage.getPageTitle()).to.eq('educacaoApp.pedagogicoCriterioAvaliacao.home.createOrEditLabel');
  ...
  it('should delete last CriterioAvaliacao', async () => {
    ...
    expect(await criterioAvaliacaoDeleteDialog.getDialogTitle()).to.eq('educacaoApp.pedagogicoCriterioAvaliacao.delete.question');
