...
describe('PlanoActividade e2e test', () => {
  ...
  it('should load PlanoActividades', async () => {
    ...
    expect(await planoActividadeComponentsPage.getTitle()).to.eq('educacaoApp.pedagogicoPlanoActividade.home.title');
  });
  ...
  it('should load create PlanoActividade page', async () => {
    ...
    expect(await planoActividadeUpdatePage.getPageTitle()).to.eq('educacaoApp.pedagogicoPlanoActividade.home.createOrEditLabel');
  ...
  it('should create and save PlanoActividades', async () => {
    ...
    await promise.all([
      ...
      planoActividadeUpdatePage.setAnoLectivoInput('5'),
      ...
      planoActividadeUpdatePage.setTurnoInput('turno'),
      planoActividadeUpdatePage.setClasseInput('5'),
      planoActividadeUpdatePage.cursoSelectLastOption(),
      planoActividadeUpdatePage.turmaSelectLastOption()
    ]);
    ...
    expect(await planoActividadeUpdatePage.getAnoLectivoInput()).to.eq('5', 'Expected anoLectivo value to be equals to 5');
    ...
    expect(await planoActividadeUpdatePage.getTurnoInput()).to.eq('turno', 'Expected Turno value to be equals to turno');
    expect(await planoActividadeUpdatePage.getClasseInput()).to.eq('5', 'Expected classe value to be equals to 5');
  ...
  it('should delete last PlanoActividade', async () => {
    ...
    expect(await planoActividadeDeleteDialog.getDialogTitle()).to.eq('educacaoApp.pedagogicoPlanoActividade.delete.question');
