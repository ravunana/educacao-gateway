...
describe('Dosificacao e2e test', () => {
  ...
  it('should load Dosificacaos', async () => {
    ...
    expect(await dosificacaoComponentsPage.getTitle()).to.eq('educacaoApp.pedagogicoDosificacao.home.title');
  });
  ...
  it('should load create Dosificacao page', async () => {
    ...
    expect(await dosificacaoUpdatePage.getPageTitle()).to.eq('educacaoApp.pedagogicoDosificacao.home.createOrEditLabel');
  ...
  /*  it('should delete last Dosificacao', async () => {
        ...
        expect(await dosificacaoDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.pedagogicoDosificacao.delete.question');
