...
describe('Horario e2e test', () => {
  ...
  it('should load Horarios', async () => {
    ...
    expect(await horarioComponentsPage.getTitle()).to.eq('educacaoApp.pedagogicoHorario.home.title');
  });
  ...
  it('should load create Horario page', async () => {
    ...
    expect(await horarioUpdatePage.getPageTitle()).to.eq('educacaoApp.pedagogicoHorario.home.createOrEditLabel');
  ...
  /*  it('should delete last Horario', async () => {
        ...
        expect(await horarioDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.pedagogicoHorario.delete.question');
