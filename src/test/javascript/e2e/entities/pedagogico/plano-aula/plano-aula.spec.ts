...
describe('PlanoAula e2e test', () => {
  ...
  it('should load PlanoAulas', async () => {
    ...
    expect(await planoAulaComponentsPage.getTitle()).to.eq('educacaoApp.pedagogicoPlanoAula.home.title');
  });
  ...
  it('should load create PlanoAula page', async () => {
    ...
    expect(await planoAulaUpdatePage.getPageTitle()).to.eq('educacaoApp.pedagogicoPlanoAula.home.createOrEditLabel');
  ...
  /*  it('should delete last PlanoAula', async () => {
        ...
        expect(await planoAulaDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.pedagogicoPlanoAula.delete.question');
