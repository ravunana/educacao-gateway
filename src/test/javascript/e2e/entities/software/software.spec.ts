...
describe('Software e2e test', () => {
  ...
  it('should load Softwares', async () => {
    ...
    expect(await softwareComponentsPage.getTitle()).to.eq('educacaoApp.software.home.title');
  });
  ...
  it('should load create Software page', async () => {
    ...
    expect(await softwareUpdatePage.getPageTitle()).to.eq('educacaoApp.software.home.createOrEditLabel');
  ...
  it('should delete last Software', async () => {
    ...
    expect(await softwareDeleteDialog.getDialogTitle()).to.eq('educacaoApp.software.delete.question');
