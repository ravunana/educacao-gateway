...
describe('Emolumento e2e test', () => {
  ...
  it('should load Emolumentos', async () => {
    ...
    expect(await emolumentoComponentsPage.getTitle()).to.eq('educacaoApp.pagamentoEmolumento.home.title');
  });
  ...
  it('should load create Emolumento page', async () => {
    ...
    expect(await emolumentoUpdatePage.getPageTitle()).to.eq('educacaoApp.pagamentoEmolumento.home.createOrEditLabel');
  ...
  it('should delete last Emolumento', async () => {
    ...
    expect(await emolumentoDeleteDialog.getDialogTitle()).to.eq('educacaoApp.pagamentoEmolumento.delete.question');
