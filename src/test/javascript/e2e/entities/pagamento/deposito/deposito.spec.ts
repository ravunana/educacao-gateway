...
describe('Deposito e2e test', () => {
  ...
  it('should load Depositos', async () => {
    ...
    expect(await depositoComponentsPage.getTitle()).to.eq('educacaoApp.pagamentoDeposito.home.title');
  });
  ...
  it('should load create Deposito page', async () => {
    ...
    expect(await depositoUpdatePage.getPageTitle()).to.eq('educacaoApp.pagamentoDeposito.home.createOrEditLabel');
  ...
  /*  it('should delete last Deposito', async () => {
        ...
        expect(await depositoDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.pagamentoDeposito.delete.question');
