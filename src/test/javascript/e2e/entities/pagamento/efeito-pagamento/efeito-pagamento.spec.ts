...
describe('EfeitoPagamento e2e test', () => {
  ...
  it('should load EfeitoPagamentos', async () => {
    ...
    expect(await efeitoPagamentoComponentsPage.getTitle()).to.eq('educacaoApp.pagamentoEfeitoPagamento.home.title');
  });
  ...
  it('should load create EfeitoPagamento page', async () => {
    ...
    expect(await efeitoPagamentoUpdatePage.getPageTitle()).to.eq('educacaoApp.pagamentoEfeitoPagamento.home.createOrEditLabel');
  ...
  /*  it('should delete last EfeitoPagamento', async () => {
        ...
        expect(await efeitoPagamentoDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.pagamentoEfeitoPagamento.delete.question');
