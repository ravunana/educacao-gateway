...
export class EfeitoPagamentoComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('rv-efeito-pagamento div table .btn-danger'));
  title = element.all(by.css('rv-efeito-pagamento div h2#page-heading span')).first();
...
export class EfeitoPagamentoUpdatePage {
  pageTitle = element(by.id('rv-efeito-pagamento-heading'));
  ...
  async pagamentoSelectLastOption(): Promise<void> {
  ...
  async pagamentoSelectOption(option: string): Promise<void> {
  ...
  async getPagamentoSelectedOption(): Promise<string> {
    return await this.pagamentoSelect.element(by.css('option:checked')).getText();
  }
...
export class EfeitoPagamentoDeleteDialog {
  private dialogTitle = element(by.id('rv-delete-efeitoPagamento-heading'));
  private confirmButton = element(by.id('rv-confirm-delete-efeitoPagamento'));
