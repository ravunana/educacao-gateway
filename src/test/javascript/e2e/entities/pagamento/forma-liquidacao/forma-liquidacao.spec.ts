...
describe('FormaLiquidacao e2e test', () => {
  ...
  it('should load FormaLiquidacaos', async () => {
    ...
    expect(await formaLiquidacaoComponentsPage.getTitle()).to.eq('educacaoApp.pagamentoFormaLiquidacao.home.title');
  });
  ...
  it('should load create FormaLiquidacao page', async () => {
    ...
    expect(await formaLiquidacaoUpdatePage.getPageTitle()).to.eq('educacaoApp.pagamentoFormaLiquidacao.home.createOrEditLabel');
  ...
  it('should delete last FormaLiquidacao', async () => {
    ...
    expect(await formaLiquidacaoDeleteDialog.getDialogTitle()).to.eq('educacaoApp.pagamentoFormaLiquidacao.delete.question');
