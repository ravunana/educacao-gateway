...
describe('AssinaturaDigital e2e test', () => {
  ...
  it('should load AssinaturaDigitals', async () => {
    ...
    expect(await assinaturaDigitalComponentsPage.getTitle()).to.eq('educacaoApp.assinaturaDigital.home.title');
  });
  ...
  it('should load create AssinaturaDigital page', async () => {
    ...
    expect(await assinaturaDigitalUpdatePage.getPageTitle()).to.eq('educacaoApp.assinaturaDigital.home.createOrEditLabel');
  ...
  /*  it('should delete last AssinaturaDigital', async () => {
        ...
        expect(await assinaturaDigitalDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.assinaturaDigital.delete.question');
