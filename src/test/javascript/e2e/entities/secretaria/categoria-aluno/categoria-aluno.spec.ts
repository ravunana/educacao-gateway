...
describe('CategoriaAluno e2e test', () => {
  ...
  it('should load CategoriaAlunos', async () => {
    ...
    expect(await categoriaAlunoComponentsPage.getTitle()).to.eq('educacaoApp.secretariaCategoriaAluno.home.title');
  });
  ...
  it('should load create CategoriaAluno page', async () => {
    ...
    expect(await categoriaAlunoUpdatePage.getPageTitle()).to.eq('educacaoApp.secretariaCategoriaAluno.home.createOrEditLabel');
  ...
  it('should delete last CategoriaAluno', async () => {
    ...
    expect(await categoriaAlunoDeleteDialog.getDialogTitle()).to.eq('educacaoApp.secretariaCategoriaAluno.delete.question');
