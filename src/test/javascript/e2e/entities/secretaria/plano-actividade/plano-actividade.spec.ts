...
describe('PlanoActividade e2e test', () => {
  ...
  it('should load PlanoActividades', async () => {
    ...
    expect(await planoActividadeComponentsPage.getTitle()).to.eq('educacaoApp.secretariaPlanoActividade.home.title');
  });
  ...
  it('should load create PlanoActividade page', async () => {
    ...
    expect(await planoActividadeUpdatePage.getPageTitle()).to.eq('educacaoApp.secretariaPlanoActividade.home.createOrEditLabel');
  ...
  it('should delete last PlanoActividade', async () => {
    ...
    expect(await planoActividadeDeleteDialog.getDialogTitle()).to.eq('educacaoApp.secretariaPlanoActividade.delete.question');
