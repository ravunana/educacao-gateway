...
describe('PlanoAula e2e test', () => {
  ...
  it('should load PlanoAulas', async () => {
    ...
    expect(await planoAulaComponentsPage.getTitle()).to.eq('educacaoApp.secretariaPlanoAula.home.title');
  });
  ...
  it('should load create PlanoAula page', async () => {
    ...
    expect(await planoAulaUpdatePage.getPageTitle()).to.eq('educacaoApp.secretariaPlanoAula.home.createOrEditLabel');
  ...
  /*  it('should create and save PlanoAulas', async () => {
        ...
        await promise.all([
            ...
            planoAulaUpdatePage.dosificacaoSelectLastOption(),
            planoAulaUpdatePage.professorSelectLastOption(),
            planoAulaUpdatePage.curriculoSelectLastOption(),
        ]);
  ...
  /*  it('should delete last PlanoAula', async () => {
        ...
        expect(await planoAulaDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.secretariaPlanoAula.delete.question');
