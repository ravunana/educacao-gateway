...
describe('PagamentoEmolumento e2e test', () => {
  ...
  it('should load PagamentoEmolumentos', async () => {
    ...
    expect(await pagamentoEmolumentoComponentsPage.getTitle()).to.eq('educacaoApp.secretariaPagamentoEmolumento.home.title');
  });
  ...
  it('should load create PagamentoEmolumento page', async () => {
    ...
    expect(await pagamentoEmolumentoUpdatePage.getPageTitle()).to.eq('educacaoApp.secretariaPagamentoEmolumento.home.createOrEditLabel');
  ...
  /*  it('should delete last PagamentoEmolumento', async () => {
        ...
        expect(await pagamentoEmolumentoDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.secretariaPagamentoEmolumento.delete.question');
