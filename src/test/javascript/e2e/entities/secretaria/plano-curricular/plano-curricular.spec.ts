...
describe('PlanoCurricular e2e test', () => {
  ...
  it('should load PlanoCurriculars', async () => {
    ...
    expect(await planoCurricularComponentsPage.getTitle()).to.eq('educacaoApp.secretariaPlanoCurricular.home.title');
  });
  ...
  it('should load create PlanoCurricular page', async () => {
    ...
    expect(await planoCurricularUpdatePage.getPageTitle()).to.eq('educacaoApp.secretariaPlanoCurricular.home.createOrEditLabel');
  ...
  /*  it('should delete last PlanoCurricular', async () => {
        ...
        expect(await planoCurricularDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.secretariaPlanoCurricular.delete.question');
