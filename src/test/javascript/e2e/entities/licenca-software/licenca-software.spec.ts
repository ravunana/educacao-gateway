...
describe('LicencaSoftware e2e test', () => {
  ...
  it('should load LicencaSoftwares', async () => {
    ...
    expect(await licencaSoftwareComponentsPage.getTitle()).to.eq('educacaoApp.licencaSoftware.home.title');
  });
  ...
  it('should load create LicencaSoftware page', async () => {
    ...
    expect(await licencaSoftwareUpdatePage.getPageTitle()).to.eq('educacaoApp.licencaSoftware.home.createOrEditLabel');
  ...
  /*  it('should delete last LicencaSoftware', async () => {
        ...
        expect(await licencaSoftwareDeleteDialog.getDialogTitle())
            .to.eq('educacaoApp.licencaSoftware.delete.question');
