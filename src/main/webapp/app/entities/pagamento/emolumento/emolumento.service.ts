...
export class EmolumentoService {
  public resourceUrl = SERVER_API_URL + 'services/pagamento/api/emolumentos';
  public resourceSearchUrl = SERVER_API_URL + 'services/pagamento/api/_search/emolumentos';
