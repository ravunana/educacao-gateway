...
import { IFormaLiquidacao, FormaLiquidacao } from 'app/shared/model/pagamento/forma-liquidacao.model';
...
export const formaLiquidacaoRoute: Routes = [
  {
    ...
    data: {
      ...
      defaultSort: 'id,asc',
      pageTitle: 'educacaoApp.pagamentoFormaLiquidacao.home.title'
    },
