...
export class PlanoAulaService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/plano-aulas';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/plano-aulas';
