...
export class CategoriaAlunoService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/categoria-alunos';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/categoria-alunos';
