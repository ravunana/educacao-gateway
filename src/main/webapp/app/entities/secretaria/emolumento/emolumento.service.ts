...
export class EmolumentoService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/emolumentos';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/emolumentos';
