...
export class DepositoService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/depositos';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/depositos';
  ...
  protected convertDateFromClient(deposito: IDeposito): IDeposito {
    const copy: IDeposito = Object.assign({}, deposito, {
      ...
      data: deposito.data && deposito.data.isValid() ? deposito.data.toJSON() : undefined
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((deposito: IDeposito) => {
        ...
        deposito.data = deposito.data ? moment(deposito.data) : undefined;
      });
    }
    return res;
  }
