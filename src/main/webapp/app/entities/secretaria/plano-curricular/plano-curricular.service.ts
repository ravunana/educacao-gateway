...
export class PlanoCurricularService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/plano-curriculars';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/plano-curriculars';
