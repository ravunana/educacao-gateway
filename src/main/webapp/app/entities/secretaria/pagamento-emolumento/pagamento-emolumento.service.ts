...
export class PagamentoEmolumentoService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/pagamento-emolumentos';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/pagamento-emolumentos';
