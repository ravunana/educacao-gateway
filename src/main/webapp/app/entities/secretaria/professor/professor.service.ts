...
export class ProfessorService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/professors';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/professors';
