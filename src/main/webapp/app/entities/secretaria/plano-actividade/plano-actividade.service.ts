...
export class PlanoActividadeService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/plano-actividades';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/plano-actividades';
