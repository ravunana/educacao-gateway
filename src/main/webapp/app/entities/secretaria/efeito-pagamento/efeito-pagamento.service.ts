...
export class EfeitoPagamentoService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/efeito-pagamentos';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/efeito-pagamentos';
