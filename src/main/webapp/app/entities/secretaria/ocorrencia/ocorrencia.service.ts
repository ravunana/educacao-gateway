...
export class OcorrenciaService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/ocorrencias';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/ocorrencias';
  ...
  protected convertDateFromClient(ocorrencia: IOcorrencia): IOcorrencia {
    const copy: IOcorrencia = Object.assign({}, ocorrencia, {
      ...
      de: ocorrencia.de && ocorrencia.de.isValid() ? ocorrencia.de.format(DATE_FORMAT) : undefined,
      ate: ocorrencia.ate && ocorrencia.ate.isValid() ? ocorrencia.ate.format(DATE_FORMAT) : undefined
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((ocorrencia: IOcorrencia) => {
        ...
        ocorrencia.de = ocorrencia.de ? moment(ocorrencia.de) : undefined;
        ocorrencia.ate = ocorrencia.ate ? moment(ocorrencia.ate) : undefined;
      });
    }
    return res;
  }
