...
export class DosificacaoService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/dosificacaos';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/dosificacaos';
