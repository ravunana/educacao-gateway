...
export class MatriculaService {
  public resourceUrl = SERVER_API_URL + 'services/secretaria/api/matriculas';
  public resourceSearchUrl = SERVER_API_URL + 'services/secretaria/api/_search/matriculas';
