...
import { ICriterioAvaliacao } from 'app/shared/model/pedagogico/criterio-avaliacao.model';
...
export class CriterioAvaliacaoService {
  public resourceUrl = SERVER_API_URL + 'services/pedagogico/api/criterio-avaliacaos';
  public resourceSearchUrl = SERVER_API_URL + 'services/pedagogico/api/_search/criterio-avaliacaos';
