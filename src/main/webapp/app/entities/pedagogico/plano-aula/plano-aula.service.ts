...
export class PlanoAulaService {
  public resourceUrl = SERVER_API_URL + 'services/pedagogico/api/plano-aulas';
  public resourceSearchUrl = SERVER_API_URL + 'services/pedagogico/api/_search/plano-aulas';
