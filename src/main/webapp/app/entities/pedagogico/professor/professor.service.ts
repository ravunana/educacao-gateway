...
export class ProfessorService {
  public resourceUrl = SERVER_API_URL + 'services/pedagogico/api/professors';
  public resourceSearchUrl = SERVER_API_URL + 'services/pedagogico/api/_search/professors';
