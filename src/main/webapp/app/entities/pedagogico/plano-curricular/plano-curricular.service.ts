...
export class PlanoCurricularService {
  public resourceUrl = SERVER_API_URL + 'services/pedagogico/api/plano-curriculars';
  public resourceSearchUrl = SERVER_API_URL + 'services/pedagogico/api/_search/plano-curriculars';
