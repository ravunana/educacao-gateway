...
export class PlanoActividadeService {
  public resourceUrl = SERVER_API_URL + 'services/pedagogico/api/plano-actividades';
  public resourceSearchUrl = SERVER_API_URL + 'services/pedagogico/api/_search/plano-actividades';
