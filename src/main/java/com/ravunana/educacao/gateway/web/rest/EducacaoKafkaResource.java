...
@RestController
@RequestMapping("/api/educacao-kafka")
public class EducacaoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EducacaoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EducacaoKafkaResource(KafkaProperties kafkaProperties) {
